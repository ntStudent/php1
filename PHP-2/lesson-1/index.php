...
<?php
    ...
    class Toad
    {
        ...
        // если у метода не указан модификатор доступа то по умолчанию стоит public (в настоящее время требуется обязательно указывать модификатор доступа, иначе выдает ошибку)
        ...
        //устанавливаем прыжок умножая параметр "х"(движение) на нужное нам число
...
// если метод что то возвращает то это -get- метод, если метод что то устанавливает то это -set- метод
        ...
        // функция назначения  координат свойствам "х" и "у" которые используются в функции "getPlace" для появления жабы
